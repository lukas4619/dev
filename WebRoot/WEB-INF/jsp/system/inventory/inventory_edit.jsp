					...
					<form action="inventory/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="number" name="INVENTORYCOUNT" id="INVENTORYCOUNT" value="${pd.INVENTORYCOUNT}" maxlength="32" placeholder="这里输入库存数量" title="库存数量" style="width:98%;"/></td>
							</tr>
							<tr>
