...
public class TaoBaoDaYu {
	 ...
	 * 接口提供访问key
	 */
	private static final String APPKEY = "23448394";

	/**
	 * 接口提供访问签名
	 */
	private static final String SECRET = "8ba93266b89deceb7cf9c0e2f7601cdd";

	/**
	 * 通知签名
	 */
	private static final String FREESIGNNAME = "大东江美食";

	/**
	 * 注册短信模版ID
	 */
	private static final String REGISTERCODE = "SMS_12976597";
	...
	public static void main(String[] args) {
		...
		sendMsgByAutoCode(sendPhone, "1224", 3);
