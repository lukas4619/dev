...
public class CacheManager
{
  ...
  public static void putCacheInfo(String key, Cache obj, long dt)
  {
    ...
    log.info("AccessToken过期时间setTimeOut:"+TimeOut);
  ...
  public static boolean cacheExpired(Cache cache)
  {
	  if (cache == null) {
	    ...
	    log.info("AccessToken当前时间："+nowDt);
	    log.info("AccessToken过期时间cacheDt:"+cacheDt);
	    log.info("AccessToken过期时间cacheDt是否大于0:"+(cacheDt > 0L));
	    log.info("AccessToken过期时间cacheDt是否小于等于nowDt:"+(cacheDt <= nowDt));
